...
\bottomrule
\endfoot
AD01 & Quyền ghi bám thẩm quyền đang hiệu lực; topology lưu trữ là điểm biến thiên. & Giữ ranh giới pháp lý mà không đồng nhất nó với biên vật lý. Sau S9, quyết định được tinh chỉnh để bảo toàn một writer hợp lệ trên mỗi phạm vi ghi và chuyển quyền có phiên bản; đổi lại, các profile phân tán phải xử lý cắt chuyển, đối soát và phục hồi phức tạp hơn. \\
\addlinespace
...
\addlinespace
AD03 & Mô hình nền pháp lý trung ương kết hợp cấu hình địa phương có phiên bản. & Cho phép biến thể nội bộ nhưng giữ nguyên thẩm quyền, trạng thái quyết định và thời hạn L1. Sau S10, cần cửa sổ tương thích và quy tắc cho hồ sơ đang xử lý; đổi lại là chi phí quản trị và kiểm thử nhiều phiên bản \citep[pp.~486--500]{gottschalk2009municipality}. \\
\addlinespace
