...
\textbf{Nền tảng số quốc gia} (I6) & Nền tảng số quản lý KH,CN\&ĐMST quốc gia giữ vai trò tổng hợp, kết nối và quan sát liên ngành \citep[khoản 3 Điều 20]{luatkhcndmst2025}. UBND cấp tỉnh mang nghĩa vụ (a) định kỳ cập nhật dữ liệu vòng đời Giấy chứng nhận DN KH\&CN lên nền tảng quốc gia \citep[khoản 3 Điều 48]{nd268_2025}; nghĩa vụ thông báo Bộ trong 15 ngày (khoản 2 Điều 66, áp dụng cả DN KNST) được xử lý riêng ở Mục~\ref{subsec:sla}. & Nền tảng đề xuất là phương tiện kỹ thuật hỗ trợ UBND cấp tỉnh thực hiện (a) qua cổng tích hợp, không tự mang nghĩa vụ pháp lý và không giữ quyền ghi cấp Bộ; không mở nhánh báo cáo song song hoặc thay thế vai trò tổng hợp quốc gia. \\
\addlinespace
\textbf{Định danh/xác thực} (I1) & Dịch vụ định danh và CSDL đăng ký doanh nghiệp giữ định danh pháp lý; nền tảng là bên sử dụng dịch vụ \citep{nd69_2024,nd169_2025}. & Không tạo định danh pháp lý song song; lưu khóa định danh chính thức và thực hiện xác thực/đối soát theo điều kiện kết nối được quy định. \\
\addlinespace
\textbf{Tỉnh--trung ương} (I2) & Cơ quan tỉnh giữ thẩm quyền đối với hồ sơ/quyết định thuộc phạm vi; trung ương nhận thông tin để tổng hợp, giám sát và quản trị chung \citep{nd268_2025,nd278_2025}. & Hợp đồng dữ liệu chung giữ mã địa bàn, hồ sơ/quyết định, trạng thái, hiệu lực, nguồn và phiên bản; trao đổi phải truy vết được và kiểm soát xử lý trùng. \\
\addlinespace
\textbf{CSDL quốc gia về doanh nghiệp} (I3) & Nguồn quốc gia giữ dữ liệu định danh doanh nghiệp có thẩm quyền \citep{luatdulieu2024,nd278_2025,qd1973_2026}. & Nền tảng tiêu thụ/tham chiếu thay vì tái sở hữu; mỗi bản ghi phụ thuộc phải giữ nguồn, phiên bản hoặc thời điểm đồng bộ. \\
\addlinespace
\textbf{Hệ thống TTHC} (I4) & Hệ thống thủ tục hành chính giữ kênh tiếp nhận/trả kết quả; nền tảng thực hiện nghiệp vụ chuyên ngành \citep{nd268_2025,nd278_2025}. & Hai miền được nối bằng định danh hồ sơ, chủ thể, thủ tục, trạng thái và kết quả; API, sự kiện hay dịch vụ dữ liệu là lựa chọn L3. \\
\addlinespace
\textbf{Nguồn bằng chứng chuyên ngành} (I5) & Hệ thống nguồn tạo hoặc xác nhận kết quả nhiệm vụ KH,CN\&ĐMST, văn bằng SHTT và bằng chứng liên quan \citep{nd268_2025}. & Nền tảng tham chiếu/xác minh và giữ xuất xứ; không giả định API bắt buộc khi nguồn hiện hành mới xác lập giá trị dữ liệu/tài liệu. \\
\end{longtable}
}

Nhãn ``(I\emph{n})'' bên cạnh mỗi ranh giới trỏ tới hàng tương ứng trong ma
trận liên thông bốn lớp EIF đầy đủ (Mục S7 của tài liệu bổ trợ); thứ tự mã
không nhất thiết trùng thứ tự dòng của bảng này vì I6 được thêm sau I1--I5
để tránh phải đánh số lại các tham chiếu hiện có.
...
Profile P-DIST -- đã giới thiệu ở Mục~\ref{subsec:arch-decisions} và Mục~\ref{subsec:phanlopdulieu} như một lựa chọn L2 của điểm biến thiên topology, không phải thành phần bắt buộc của lõi SRA -- được Hình~\ref{fig:pdist-main} minh họa ở mức deployment logic để cho thấy vị trí tương đối của nút tỉnh, nút trung ương và hạ tầng chia sẻ/điều phối; hình không ấn định sản phẩm CSDL, middleware hay giao thức cụ thể.

\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{figure_sources/fig06_c4_deployment_pdist.pdf}
