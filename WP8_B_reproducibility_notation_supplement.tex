...
\section*{B. Quy tắc sinh và bao phủ bộ kịch bản S1--S10}
...
\midrule
COV1 & Vận hành bình thường và biến thể địa phương & S1, S2 & Thẩm quyền bình thường; cấu hình quy trình địa phương. \\
COV2 & Thay đổi quy định, nguồn hoặc phiên bản & S3, S6, S10 & Thay đổi quy định; thay đổi nguồn có thẩm quyền; nâng cấp cuốn chiếu. \\
COV3 & Gián đoạn hạ tầng/lớp trung ương & S4, S7 & Mất liên thông và mất lớp điều phối trung ương. \\
COV4 & Tổng hợp toàn quốc và quan hệ xuyên địa bàn & S5, S8 & Độ mới/tổng hợp và liên kết vượt biên thẩm quyền. \\
COV5 & Chuyển quyền quản lý/ghi & S9 & Quyền ghi theo thời gian và chuyển giao thẩm quyền. \\
\bottomrule
\end{tabularx}
...
\toprule
\smallhead{S} & \smallhead{Nhóm} & \smallhead{DRV} & \smallhead{Góc nhìn} & \smallhead{Điều kiện được thử} \\
\midrule
S1 & COV1 & DRV1 & V1, V3, V4 & Tỉnh xử lý/quyết định trong phạm vi thẩm quyền. \\
S2 & COV1 & DRV2, DRV5 & V2, V4, V6 & Khác biệt bước nội bộ nhưng giữ nghĩa vụ pháp lý. \\
S3 & COV2 & DRV2, DRV5 & V2, V4, V5, V6 & Thay đổi biểu mẫu/trạng thái/thời hạn bắt buộc. \\
S4 & COV3 & DRV3, DRV4, DRV5 & V4, V5, V6 & Gián đoạn lớp chia sẻ sau quyết định của tỉnh. \\
S5 & COV4 & DRV4, DRV5 & V1, V3, V4, V5 & Đọc/tổng hợp toàn quốc và độ mới của bản đọc. \\
S6 & COV2 & DRV4, DRV5 & V3, V4, V6 & Nguồn định danh quốc gia thay đổi dữ liệu/tham chiếu. \\
S7 & COV3 & DRV3, DRV4 & V1, V4, V5 & Lớp trung ương không sẵn sàng khi tỉnh đang xử lý. \\
S8 & COV4 & DRV1, DRV4 & V1, V3, V4 & Quan hệ hệ sinh thái xuyên tỉnh. \\
S9 & COV5 & DRV1, DRV4, DRV5 & V1, V3, V4, V5, V6 & Chuyển phạm vi quản lý/quyền ghi giữa hai tỉnh. \\
S10 & COV2 & DRV2, DRV4, DRV5 & V2, V3, V4, V5, V6 & Nâng cấp lược đồ/quy trình không đồng thời. \\
\bottomrule
\end{tabularx}
...
\vspace{7pt}
\textbf{Kết quả B1$_0$:} 2 ĐÁP ỨNG TRỰC TIẾP + 7 ĐÁP ỨNG CÓ ĐIỀU KIỆN + 1 RỦI RO KIẾN TRÚC. Ma trận bao phủ làm rõ phạm vi đã thử, không chứng minh bộ mười kịch bản là đầy đủ mọi tình huống có thể xảy ra.
\newpage

\section*{C. Hồ sơ ký pháp của Hình 1--5}
...
H4 & Ranh giới vùng chứa logic & C4 Model -- Container logic & Person; Container; Software System; quan hệ một chiều có nhãn. & Công nghệ/giao thức cụ thể là L3 chưa khóa; hình là góc nhìn logic, không phải đặc tả triển khai đầy đủ. \\
H5 & Mẫu triển khai logic & C4 Deployment & Deployment Node; Container instance; Infrastructure Node. & Ánh xạ các vùng chứa H4 vào nút triển khai; môi trường, nền tảng và giao thức cụ thể vẫn là L3. \\
\bottomrule
\end{tabularx}

\vspace{10pt}
\textbf{Nguyên tắc hardening WP8-B.}
\begin{itemize}[leftmargin=1.5em,itemsep=2pt]
\item TikZ chỉ là công cụ vẽ; nghĩa của phần tử/quan hệ do góc nhìn ArchiMate/C4 quy định.
\item Các lựa chọn công nghệ/giao thức không được suy đoán nếu không phải ràng buộc L1/L2; H4--H5 ghi rõ chúng chưa khóa ở L3.
\item Hình 3 loại bỏ nhãn quan hệ lặp và định tuyến Access ra ngoài hộp dữ liệu để tránh giao cắt chữ; Hình 4 giảm quan hệ hai chiều thành phụ thuộc một chiều có nhãn; Hình 5 tách rõ nút triển khai và bản thực thi vùng chứa.
...
\vfill
\textbf{Đối soát cuối WP8-B:} 116 đơn vị nguồn; 128 mệnh đề nguyên tử (114 A, 8 D, 6 M); lớp A = 110 ĐÁP ỨNG + 3 MỘT PHẦN + 1 CẦN LÀM RÕ; 10 kịch bản = 2 trực tiếp + 7 có điều kiện + 1 rủi ro; 5 hình kiến trúc H1--H5; 37/37 tài liệu tham khảo được dùng và đúng thứ tự xuất hiện đầu tiên.
\end{document}
