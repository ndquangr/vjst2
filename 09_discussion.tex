...
Hai đóng góp kiến trúc ở Mục~\ref{subsec:scope-viewpoints}--\ref{subsec:arch-decisions} và các phát hiện của stress-test khái quát thành ba nguyên tắc thiết kế có điều kiện, có khả năng chuyển giao cho các nền tảng khu vực công có phân cấp thẩm quyền, nhiều nguồn dữ liệu có thẩm quyền và yêu cầu liên thông đa cấp tương tự -- không phải quy luật phổ quát: \textbf{P1}, phân rã thẩm quyền theo nhóm thuộc tính--phạm vi--thời gian thay vì gán toàn bộ thực thể cho một CSDL hoặc một cơ quan; \textbf{P2}, giữ thẩm quyền, trạng thái quyết định và thời hạn bắt buộc trong lõi ổn định trong khi bước xử lý nội bộ và cấu hình địa phương là biến thể có kiểm soát, version hóa; \textbf{P3}, bảo toàn biên thẩm quyền, trách nhiệm liên thông và nguồn gốc dữ liệu bất kể kho lưu trữ tập trung, phân vùng hay phân tán. Cơ sở đầy đủ của ba nguyên tắc đã được lập luận ở Mục~\ref{subsec:scope-viewpoints}--\ref{subsec:arch-decisions}; phần còn lại của mục này chỉ đối sánh mức độ SRA đã neo vào các khung hiện hành.
...
\midrule
QĐ 3090/QĐ-BKHCN, Điều 1 \citep{qd3090_2025} & Nền tảng chuyên ngành phải được đặt trong hệ quy chiếu kiến trúc số quốc gia, tránh hình thành kiến trúc biệt lập. & Hình~\ref{fig:dinhvi} định vị SRA giữa khung số, dữ liệu và nghiệp vụ; stable core/variation tách nghĩa vụ ổn định khỏi lựa chọn công nghệ. & Hình~\ref{fig:dinhvi}; Mục~\ref{subsec:phanlop}. \\
QĐ 292/QĐ-BKHCN, Chương 2 Mục II; Chương 3 Mục II.6--7 \citep{qd292_2025} & Kiểm tra theo các mô hình tham chiếu nghiệp vụ, dữ liệu, ứng dụng, công nghệ, ATTT; sử dụng lớp tích hợp/chia sẻ quốc gia và cấp bộ/tỉnh. & Các góc nhìn năng lực--ứng dụng, dữ liệu--thẩm quyền và container tách ranh giới trách nhiệm; trao đổi liên cơ quan đi qua lớp tích hợp thay vì kết nối điểm--điểm tùy ý. & Hình~\ref{fig:dinhvi}; Hình~\ref{fig:ranhgioi}; Mục~\ref{sec:interop}. \\
