...
\toprule
\textbf{Kịch bản} & \textbf{B1} & \textbf{B1-R} & \textbf{Neo kiến trúc} & \textbf{Kiểm chứng hiện thực hóa cần thiết} \\
\midrule
\endfirsthead
\toprule
\textbf{Kịch bản} & \textbf{B1} & \textbf{B1-R} & \textbf{Neo kiến trúc} & \textbf{Kiểm chứng hiện thực hóa cần thiết} \\
...
\bottomrule
\endfoot
SC1. Tỉnh xử lý/quyết định theo thẩm quyền & Trực tiếp & Trực tiếp & AD01, AE24, CR2 & Định tuyến theo phạm vi và từ chối ghi ngoài phạm vi đang có hiệu lực. \\
SC2. Hai tỉnh khác bước nội bộ & Trực tiếp & Trực tiếp & AD03, AE26, CR5 & Kiểm tra cấu hình địa phương không nới trạng thái, thẩm quyền hay thời hạn L1. \\
SC3. Quy định thay đổi & Có điều kiện & Có điều kiện & AD03, CR6 & Hồi quy cấu hình; phát hành phiên bản mới; xử lý hồ sơ đang chạy và lịch sử. \\
SC4. Chia sẻ trung ương gián đoạn & Có điều kiện & Có điều kiện & AD04, CR8 & Gửi lại có kiểm soát, chống xử lý trùng, bảo toàn trạng thái và thời hạn nghiệp vụ. \\
SC5. Ảnh dữ liệu toàn quốc & Có điều kiện & Có điều kiện & AE25, CR7 & Đo độ mới, kiểm tra provenance/phiên bản và đối soát với nguồn tạo lập. \\
SC6. Định danh doanh nghiệp đổi ở nguồn quốc gia & Có điều kiện & Có điều kiện & AE03, AE15, CR4 & Làm mới/xác minh nguồn và xử lý thay đổi khóa/tham chiếu mà không tạo bản chủ cạnh tranh. \\
SC7. Lớp trung ương không sẵn sàng & Có điều kiện & Có điều kiện & AD04, V4/V5 & Thử miền lỗi và xác minh bước nào được tiếp tục, dừng hoặc khôi phục theo phụ thuộc ngoài. \\
SC8. Quan hệ xuyên tỉnh & Có điều kiện & Có điều kiện & AD05, CR9 & Hợp nhất quan hệ theo định danh, nguồn, hai đầu quan hệ và thời gian hiệu lực. \\
SC9. Chuyển phạm vi quản lý A--B & Rủi ro & Có điều kiện & AD01, CR2--CR3 & Ghi cạnh tranh, cutover, khởi động lại, gửi lại và forward recovery phải giữ single-active-writer/provenance. \\
SC10. Nâng lược đồ/quy trình lệch thời điểm & Có điều kiện & Có điều kiện & AD03, CR6 & Ma trận tương thích, nâng cấp cuốn chiếu, version pinning và phát lại dữ liệu lịch sử. \\
\end{longtable}
\normalsize
